...
call cal_area(point(:,triangle(1,1)),point(:,triangle(2,1)),point(:,triangle(3,1)),area(1))
call cal_area(point(:,triangle(1,2)),point(:,triangle(2,2)),point(:,triangle(3,2)),area(2))
