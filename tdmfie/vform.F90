!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! $URL: svn://land/projects/tdefie08/trunk/vform.F90 $
! $Id: vform.F90 84 2008-03-10 10:38:12Z cai $
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#include "defines.F90"
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
type(t_triangle) triangle(:)
    ...
    do j_var=0, i_rank-1
        v_rhs(row, :)=v_rhs(row, :)+out_cni(n_var,:,j_var)* &
            (bmnij(0,mn_pos)*scaling_s+ &
            amnij(i_rank-j_var,mn_pos)+bmnij(i_rank-j_var,mn_pos)* &
            scaling_s*.5_DKIND)
        temp=0._DKIND
        do k_var=0, j_var-1
